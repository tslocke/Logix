...
#
# This class is copied with thanks, from the ipython source distribution
# http://ipython.scipy.org
# Author: Jack Moffit <jack@xiph.org>
...
lxfiles = filter(isfile, glob('ltest/*.lx'))

setup(name="ltest",
      version="0.4",
      description="Logix-Test - a unit testing framework for Logix",
      author="Tom Locke",
      author_email="tom@livelogix.com",
      url="http://logix.livelogix.com",
      packages=['ltest'],
      license='GNU GPL',

      cmdclass={'install_data': install_data_ext},
      data_files=[('lib', 'ltest', lxfiles)],
     )
from distutils.core import setup
